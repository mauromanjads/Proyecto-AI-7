...
export default class Tablero {
    ...
    mostrarProgreso(
        ...
        for (
            ...
            nodos +=
                `<div class="progreso-nodo-contenedor ${estado}"><div class="progreso-nodo ${estado}"></div><span class="progreso-nodo-numero">${i}</span></div>`;

        }

        this.divProgreso.innerHTML =
            `<div class="progreso-nodos">${nodos}</div>`;
    ...
    mostrarNarrativa(
        ...
        const contenedorCapitulo =
            document.createElement("div");

        contenedorCapitulo.id =
            "capitulo-narrativo";

        contenedorCapitulo.className =
            "registro-eventos";
        ...
        botonCapitulo.className =
            "registro-eventos-toggle";

        botonCapitulo.innerHTML =
            `<div class="registro-eventos-icono">◈</div><h3>CAPÍTULO ${this.juego.capituloActual + 1}</h3><span class="registro-eventos-flecha">▾</span>`;

        botonCapitulo.addEventListener(
            "click",
            evento => {
        ...
        contenedorCapitulo.appendChild(
            botonCapitulo
        );

        const contenedorEvento =
            document.createElement("div");

        contenedorEvento.id =
            "registro-eventos";

        contenedorEvento.className =
            "registro-eventos";
        ...
        botonEvento.innerHTML =
            `<div class="registro-eventos-icono">◈</div><h3>EVENTO #${numeroCaso}</h3><span class="registro-eventos-flecha">▾</span>`;

        botonEvento.addEventListener(
            "click",
            evento => {
        ...
        contenedorEvento.appendChild(
            botonEvento
        );

        const contenedorNexus =
            document.createElement("div");

        contenedorNexus.id =
            "analisis-nexus";

        contenedorNexus.className =
            "analisis-nexus";
        ...
        botonNexus.className =
            "registro-eventos-toggle";

        botonNexus.innerHTML =
            `<div class="registro-eventos-icono">⌬</div><h3>ANÁLISIS NEXUS</h3><span class="registro-eventos-flecha">▾</span>`;

        botonNexus.addEventListener(
            "click",
            evento => {
